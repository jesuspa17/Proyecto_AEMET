...
public class Dia {
    ...
    @ElementList(name = "sens_termica", inline = true)
    private List<Sens_termica> sens_termica;


    public Dia(){}

    public Dia(Date fecha, Temperatura temperatura, List<Cota_nieve_prov> cota_nieve_prov, List<Prob_precipitacion> prob_precipitacion, List<Estado_cielo> estado_cielo, List<Sens_termica> sens_termica) {
        this.fecha = fecha;
    ...
    public List<Sens_termica> getSens_termica() {
        return sens_termica;
    }

    public void setSens_termica(List<Sens_termica> sens_termica) {
        this.sens_termica = sens_termica;
    }
