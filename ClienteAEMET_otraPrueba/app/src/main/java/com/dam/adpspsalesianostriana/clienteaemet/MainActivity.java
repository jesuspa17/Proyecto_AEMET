...
import com.dam.adpspsalesianostriana.clienteaemet.Adaptador.TiempoAdapter_prueba;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setAdapter(new TiempoAdapter_prueba(MainActivity.this, url_ciudad, ciudad, fecha_elaboracion));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                new BusquedaRequest(MainActivity.this,autoCompleteCiudad);


                /*String url_municipios = URL_BUSCADOR + autoCompleteCiudad.getText().toString();
